...
request to the Quarkus API when the user submits their credentials.
...
The REST API exposes a single endpoint and implements the login use-case using a layered hexagonal (ports-and-adapters)
architecture:
