...
[CI Workflows]({% link extreme-programming/reference/ci-workflows.md %}).
...
and the concrete workflow shape in [GitHub CI Path Filtering]({% link extreme-programming/reference/github-ci-path-filtering.md %}).
...
Read together with [GitHub Branch Protection Rationale]({% link extreme-programming/explanation/github-branch-protection-rationale.md %}),
