...
> [GitHub Branch Protection Rationale]({% link extreme-programming/explanation/github-branch-protection-rationale.md %}#direct-pushes).
...
[required status checks]({% link extreme-programming/how-to/configure-github-repository-protection.md %}#require-status-checks-before-merging)
...
server-side by [requiring a pull request and status checks]({% link extreme-programming/how-to/configure-github-repository-protection.md %}#require-a-pull-request-before-merging).
